The computation of Lagrangian flow maps \textit{in situ} to enable \textit{post hoc} time-varying vector field analysis has recently become an active area of research. 
%
