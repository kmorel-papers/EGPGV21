...
%
\fix{Lagrangian analysis modules are available in the latest releases of the open-source Ascent~\cite{Larsen2017Ascent} and VTK-m~\cite{moreland2016vtk} libraries.}
%
