...
%
\fix{Lagrangian analysis capabilities are accessible via the open-source Ascent library, and a single-node shared memory version is accessible directly via VTK-m.}
%
