...
\label{fig:jet_7}
\end{subfigure}
\caption{\fix{For the Jet data set, we observed a low tolerance for data reduction. A high data reduction factor resulted in an increase in the percentage of particles reconstructed up to a few grid cell sides away from the ground truth.}} 
\vspace{-5mm}
\label{fig:jet_map}
\end{figure}
