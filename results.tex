...
%
Figure~\ref{abc_ftle} visualizes the FTLE field derived using the T6 Lagrangian$_{Local}$ flow map and annotates a discontinuity in the FTLE field caused by discarded particles.
...
%
Figure~\ref{nyx_ftle} shows the FTLE field derived using the T1 Lagrangian$_{Local}$ flow map. 
%
