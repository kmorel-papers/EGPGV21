...
%
\fix{Although Figure~\ref{abc_ftle} shows the FTLE field derived from the reduced Lagrangian$_{Local}$ test T6 is similar to the ground truth, it contains some error along the node boundaries.}
...
%
The result indicated the error introduced from  
}
%
