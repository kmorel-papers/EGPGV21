...
Overall, using Lagrangian$_{Local}$ with a storage interval of 25 cycles and 1:8 data reduction factor, the complete Lagrangian flow map can be reconstructed accurately (under 100% of GCS) while providing speed-ups of 2x-4x for the Cloverleaf3D data set.
